...
askitApp.controller('entrainementAramCtrl', ['$scope', '$state', function($scope, $state) {		
  ...
  $scope.gotoCarte = function () {
	...
	function playAtThisTime(nextMp3){
		audio.src = "Media/Memo/Aram/"+nextMp3+".mp3";
		audio.play();
	}

	function play(){
		audio.src = "Media/Memo/Aram/"+mp3_part+".mp3";
		audio.play();
	}
    ...
    $('.end').click(function () {   
	 ...
	 function playTxt1(){
	 	if(txt1 == 1){
	 		mp3_part = "MM-Lo-Am-1a";
	 		showPage(1);
	 		play();
	 	}else{
	 		mp3_part = "MM-Lo-Am-2a";
	 		playTxt2();
	 	}
	 }
...
/////////////////////////////////////////////
	...
	officePlayer.ontimeupdate=function(){
		...
		if(currentTime >= audio2.duration){
			...
			if(mp3_part == "MM-Lo-Am-1a"){
				playTxt2();
			}else if(mp3_part == "MM-Lo-Am-2a"){
				playTxt3();
			}else if(mp3_part == "MM-Lo-Am-3a"){
				playTxt4();
			}else if(mp3_part == "MM-Lo-Am-4a"){
				playTxt5();
			}else if(mp3_part == "MM-Lo-Am-5a"){
				playTxt6();
			}else if(mp3_part == "MM-Lo-Am-6a"){
				playTxt7();
			}else if(mp3_part == "MM-Lo-Am-7a"){
				playTxt8();
			}else if(mp3_part == "MM-Lo-Am-8a"){
				playTxt9();
			}else if(mp3_part == "MM-Lo-Am-9a"){
				playTxt10();
			}else if(mp3_part == "MM-Lo-Am-10a"){
				playTxt11();
			}

			else if(mp3_part == "MM-Lo-Am-11a"){
				playTxt1e();
			}
			/////////////////
			else if(mp3_part == "MM-Lo-Am-1b"){
				playTxt2e();
			}else if(mp3_part == "MM-Lo-Am-2b"){
				playTxt3e();
			}else if(mp3_part == "MM-Lo-Am-3b"){
				playTxt4e();
			}else if(mp3_part == "MM-Lo-Am-4b"){
				playTxt5e();
			}else if(mp3_part == "MM-Lo-Am-5b"){
				playTxt6e();
			}else if(mp3_part == "MM-Lo-Am-6b"){
				playTxt7e();
			}else if(mp3_part == "MM-Lo-Am-7b"){
				playTxt8e();
			}else if(mp3_part == "MM-Lo-Am-8b"){
				playTxt9e();
			}else if(mp3_part == "MM-Lo-Am-9b"){
				playTxt10e();
			}else if(mp3_part == "MM-Lo-Am-10b"){
				playTxt11e();
			}else if(mp3_part == "MM-Lo-Am-11b"){
				wait(800);
				$('.select-test').click();
			}
		}
