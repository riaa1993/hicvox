...
askitApp.controller('entrainementLatinCtrl', ['$scope', '$state', function($scope, $state) {		
  ...
  $scope.gotoCarte = function () {
   ...
   //      });   		
	...
	function playAtThisTime(nextMp3){				
		audio.src = "Media/Memo/Latin/"+nextMp3+".mp3";
		audio.play();
	}	

	function play(){				
		audio.src = "Media/Memo/Latin/"+mp3_part+".mp3";
		audio.play();
	}	
    ...
    $('.end').click(function () {   
	 ...
	 function playTxt1(){
	 	if(txt1 == 1){	 
	 		mp3_part = "MM-Litanie-Lat-1a";		 
	 		showPage(1);
	 		play();
	 	}else{
	 		mp3_part = "MM-Litanie-Lat-2a";
	 		playTxt2();
	 	}
	 }
...
/////////////////////////////////////////////
	...
	officePlayer.ontimeupdate=function(){
		...
		if(currentTime >= audio2.duration){
			...
			if(mp3_part == "MM-Litanie-Lat-1a"){
				playTxt2();
			}else if(mp3_part == "MM-Litanie-Lat-2a"){
				playTxt3();
			}else if(mp3_part == "MM-Litanie-Lat-3a"){
				playTxt4();
			}else if(mp3_part == "MM-Litanie-Lat-4a"){
				playTxt5();
			}else if(mp3_part == "MM-Litanie-Lat-5a"){
				playTxt6();
			}else if(mp3_part == "MM-Litanie-Lat-6a"){
				playTxt7();
			}else if(mp3_part == "MM-Litanie-Lat-7a"){
				playTxt1e();
			}
			/////////////////
			else if(mp3_part == "MM-Litanie-Lat-1b"){
				playTxt2e();
			}else if(mp3_part == "MM-Litanie-Lat-2b"){
				playTxt3e();
			}else if(mp3_part == "MM-Litanie-Lat-3b"){
				playTxt4e();
			}else if(mp3_part == "MM-Litanie-Lat-4b"){
				playTxt5e();
			}else if(mp3_part == "MM-Litanie-Lat-5b"){
				playTxt6e();
			}else if(mp3_part == "MM-Litanie-Lat-6b"){
				playTxt7e();
			}else if(mp3_part == "MM-Litanie-Lat-7b"){
				wait(800);			
				// playTxt1();
           		console.log(arr);				
				$('.select-test').click();
