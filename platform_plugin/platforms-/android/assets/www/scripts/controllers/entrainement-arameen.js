...
askitApp.controller('entrainementArameenCtrl', ['$scope', '$state', function($scope, $state) {		
  ...
  $scope.gotoCarte = function () {
   ...
   //      });   		
	...
	function playAtThisTime(nextMp3){
		audio.src = "Media/Memo/Arameen/"+nextMp3+".mp3";
		audio.play();
	}

	function play(){
		audio.src = "Media/Memo/Arameen/"+mp3_part+".mp3";
		audio.play();
	}
    ...
    $('.end').click(function () {   
	 ...
	 function playTxt1(){
	 	if(txt1 == 1){
	 		mp3_part = "MM-Litanie-Ara-1a";		 
	 		showPage(1);
	 		play();
	 	}else{
	 		mp3_part = "MM-Litanie-Ara-2a";
	 		playTxt2();
	 	}
	 }
...
/////////////////////////////////////////////
	...
	officePlayer.ontimeupdate=function(){
		...
		if(currentTime >= audio2.duration){
			...
			if(mp3_part == "MM-Litanie-Ara-1a"){
				playTxt2();
			}else if(mp3_part == "MM-Litanie-Ara-2a"){
				playTxt3();
			}else if(mp3_part == "MM-Litanie-Ara-3a"){
				playTxt4();
			}else if(mp3_part == "MM-Litanie-Ara-4a"){
				playTxt1e();
			}
			/////////////////
			else if(mp3_part == "MM-Litanie-Ara-1b"){
				playTxt2e();
			}else if(mp3_part == "MM-Litanie-Ara-2b"){
				playTxt3e();
			}else if(mp3_part == "MM-Litanie-Ara-3b"){
				playTxt4e();
			}else if(mp3_part == "MM-Litanie-Ara-4b"){
				wait(800);           		
				$('.select-test').click();
			}
		}
