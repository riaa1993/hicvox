...
askitApp.controller('entrainementSlavonCtrl', ['$scope', '$state', function($scope, $state) {		
  ...
  $scope.gotoCarte = function () {
	...
	function playAtThisTime(nextMp3){
		audio.src = "Media/Memo/Slavon/"+nextMp3+".mp3";
		audio.play();
	}

	function play(){
		audio.src = "Media/Memo/Slavon/"+mp3_part+".mp3";
		audio.play();
	}
    ...
    $('.end').click(function () {   
	 ...
	 function playTxt1(){
	 	if(txt1 == 1){
	 		mp3_part = "MM-Lo-Sl-1a";
	 		showPage(1);
	 		play();
	 	}else{
	 		mp3_part = "MM-Lo-Sl-2a";
	 		playTxt2();
	 	}
	 }
...
/////////////////////////////////////////////
	...
	officePlayer.ontimeupdate=function(){
		...
		if(currentTime >= audio2.duration){
			...
			if(mp3_part == "MM-Lo-Sl-1a"){
				playTxt2();
			}else if(mp3_part == "MM-Lo-Sl-2a"){
				playTxt3();
			}else if(mp3_part == "MM-Lo-Sl-3a"){
				playTxt4();
			}else if(mp3_part == "MM-Lo-Sl-4a"){
				playTxt5();
			}else if(mp3_part == "MM-Lo-Sl-5a"){
				playTxt6();
			}else if(mp3_part == "MM-Lo-Sl-6a"){
				playTxt7();
			}else if(mp3_part == "MM-Lo-Sl-7a"){
				playTxt8();
			}else if(mp3_part == "MM-Lo-Sl-8a"){
				playTxt1e();
			}
			
			/////////////////
			else if(mp3_part == "MM-Lo-Sl-1b"){
				playTxt2e();
			}else if(mp3_part == "MM-Lo-Sl-2b"){
				playTxt3e();
			}else if(mp3_part == "MM-Lo-Sl-3b"){
				playTxt4e();
			}else if(mp3_part == "MM-Lo-Sl-4b"){
				playTxt5e();
			}else if(mp3_part == "MM-Lo-Sl-5b"){
				playTxt6e();
			}else if(mp3_part == "MM-Lo-Sl-6b"){
				playTxt7e();
			}else if(mp3_part == "MM-Lo-Sl-7b"){
				playTxt8e();
			}else if(mp3_part == "MM-Lo-Sl-8b"){
				wait(800);
				$('.select-test').click();
			}
		}
