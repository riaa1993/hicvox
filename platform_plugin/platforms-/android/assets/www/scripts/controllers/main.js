...
askitApp.controller('calendrierCtrl', ['$scope', '$timeout', '$http', '$cordovaFile', '$cordovaFileTransfer', '$state', function($scope, $timeout, $http, $cordovaFile, $cordovaFileTransfer, $state) {  	  		
	...
	var options = {};
  	...
  	if($('#repere').val() == "1"){  		
	    if(localStorage.getItem("check-liturgia") == null){  		    	
	    	document.addEventListener('deviceready', function () {
		        $state.go('liturgia-dwn', null, { reload: true });
		    });
	     	localStorage.setItem("check-liturgia", 1);
	    }
	    if(localStorage.getItem("check-download-liturgia") == null){  }else{    	    	
		    document.getElementById('downloadBtn').style.display = "none";
		}
   	}else{
	    if(localStorage.getItem("check-bervarium") == null){	    	
	    	document.addEventListener('deviceready', function () {
		        $state.go('breviarium-dwn', null, { reload: true });	    	
		    });
	     	localStorage.setItem("check-bervarium", 1);
	    }
	    if(localStorage.getItem("check-download-bervarium") == null){  }else{    
		    document.getElementById('downloadBtn').style.display = "none";
		}
   }

  	$scope.specialDirectory = "file:///storage/sdcard0/";
  ...
  $scope.getTheMD = function(day) {      
	...
	if(parseInt(todayDate.getFullYear()) < 2017){
		$scope.theYear = 2017;
	}
	else{
  ...
  window.addEventListener('touchstart', function() {   
   ...
   stopTime();
	...
	$scope.getMp3Office = function() {
		...
		$timeout(function() {
			...
			if(classe == 4){
				...
				$scope.mp3_te_deum  = $scope.specialDirectory+'Hicvox/Audio/eLa-TeDeum-v0.mp3';
			}
		...
		path_conclusion = $scope.specialDirectory+"Hicvox/Audio/";
		path_oraison = $scope.specialDirectory+"Hicvox/Audio/";
		$scope.mp3_office_mat = $scope.specialDirectory+"Hicvox/Audio/eLa-PrI-Mat-v0.mp3";
		$scope.mp3_office_com = "Media/Audio/eLa-PrI-Com-v0.mp3";
		...
		if(commun == ""){
		    mp3_inv        = $scope.specialDirectory+'Hicvox/Audio/eLa-Inv-Ord-'+numday+''+numoffice+'1-'+inv+'-v0.mp3';
		    mp3_inv_2      = $scope.specialDirectory+'Hicvox/Audio/eLa-Inv-Ord-'+numday+''+numoffice+'2-'+inv+'-v0.mp3';
		    mp3_inv_pascal_1 = $scope.specialDirectory+'Hicvox/Audio/eLa-Inv-TRe-0001-v0.mp3';
		    mp3_inv_pascal_2 = $scope.specialDirectory+'Hicvox/Audio/eLa-Inv-TRe-0002-v0.mp3';
		}else{
		    mp3_inv        = $scope.specialDirectory+'Hicvox/Audio/eLa-Inv-'+commun+'-ht1-'+inv+'-v0.mp3';
		    mp3_inv_2      = $scope.specialDirectory+'Hicvox/Audio/eLa-Inv-'+commun+'-ht2-'+inv+'-v0.mp3';
		    mp3_inv_pascal_1 = $scope.specialDirectory+'Hicvox/Audio/eLa-Inv-'+commun+'-tp1-'+inv+'-v0.mp3';
		    mp3_inv_pascal_2 = $scope.specialDirectory+'Hicvox/Audio/eLa-Inv-'+commun+'-tp2-'+inv+'-v0.mp3';
		}
		...
		if(commun == ""){
		    hymne_matines  = $scope.specialDirectory+'Hicvox/Audio/eLa-Hym-Ord-'+matines_hymnes+''+numoffice+'-v0.mp3';
		}else{
		    if(commun == "CAp" || commun == "CMu" || commun == "CMm"){
		        hymne_matines  = $scope.specialDirectory+'Hicvox/Audio/eLa-Hym-'+commun+'-hp'+numoffice+'-v0.mp3';
		        hymne_matines_pascal  = $scope.specialDirectory+'Hicvox/Audio/eLa-Hym-'+commun+'-tt'+numoffice+'-v0.mp3';
		    }else{
		        hymne_matines  = $scope.specialDirectory+'Hicvox/Audio/eLa-Hym-'+commun+'-hp'+numoffice+'-v0.mp3';
		        hymne_matines_pascal  = $scope.specialDirectory+'Hicvox/Audio/eLa-Hym-'+commun+'-tt'+numoffice+'-v0.mp3';
		    }
		...
		mp3_hymne_laudes  = $scope.specialDirectory+'Hicvox/Audio/eLa-Hym-Ord-'+numday+''+numoffice+'-v0.mp3';
		mp3_hymne_vepres  = $scope.specialDirectory+'Hicvox/Audio/eLa-Hym-Ord-'+numday+''+numoffice+'-v0.mp3';

		mp3_hymne_complies= $scope.specialDirectory+'Hicvox/Audio/eLa-Hym-0'+numoffice+''+hymnes_pth+'-v0.mp3';
		mp3_hymne_nones   = $scope.specialDirectory+'Hicvox/Audio/eLa-Hym-0'+numoffice+''+hymnes_pth+'-v0.mp3';
		mp3_hymne_primes  = $scope.specialDirectory+'Hicvox/Audio/eLa-Hym-0'+numoffice+''+hymnes_pth+'-v0.mp3';
		mp3_hymne_sextes  = $scope.specialDirectory+'Hicvox/Audio/eLa-Hym-0'+numoffice+''+hymnes_pth+'-v0.mp3';
		mp3_hymne_tierces = $scope.specialDirectory+'Hicvox/Audio/eLa-Hym-0'+numoffice+''+hymnes_pth+'-v0.mp3';

		mp3_hymne_laudes_pascal  = $scope.specialDirectory+'Hicvox/Audio/eLa-Hym-TRe-002-v0.mp3';
		mp3_hymne_vepres_pascal  = $scope.specialDirectory+'Hicvox/Audio/eLa-Hym-TRe-007-v0.mp3';

		// #################################
		// - ANTIENNE -
		// #################################
		
		mp3_ant_matines_1      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'1-v0.mp3';
		mp3_ant_matines_2      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'2-v0.mp3';
		mp3_ant_matines_3      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'3-v0.mp3';
		mp3_ant_matines_4      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'4-v0.mp3';
		mp3_ant_matines_5      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'5-v0.mp3';
		mp3_ant_matines_6      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'6-v0.mp3';
		mp3_ant_matines_7      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'7-v0.mp3';
		mp3_ant_matines_8      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'8-v0.mp3';
		mp3_ant_matines_9      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'9-v0.mp3';

		mp3_ant_matines_pascal = $scope.specialDirectory+'Hicvox/Audio/eLa-Ant-TRe-'+matines_pascal+'-v0.mp3';
		mp3_ant_pascal = $scope.specialDirectory+'Hicvox/Audio/eLa-Ant-TRe-00-v0.mp3';

		mp3_ant_complies       = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'1-v0.mp3';
		mp3_ant_nones          = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'1-v0.mp3';
		mp3_ant_primes         = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'1-v0.mp3';
		mp3_ant_sextes         = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'1-v0.mp3';
		mp3_ant_tierces        = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'1-v0.mp3';

		mp3_ant_laudes_1      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'1-v0.mp3';
		mp3_ant_laudes_2      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'2-v0.mp3';
		mp3_ant_laudes_3      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'3-v0.mp3';
		mp3_ant_laudes_4      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'4-v0.mp3';
		mp3_ant_laudes_5      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'5-v0.mp3';

		mp3_ant_vepres_1      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'1-v0.mp3';
		mp3_ant_vepres_2      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'2-v0.mp3';
		mp3_ant_vepres_3      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'3-v0.mp3';
		mp3_ant_vepres_4      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'4-v0.mp3';
		mp3_ant_vepres_5      = $scope.specialDirectory+'Hicvox/Audio/eLa-AnP-Ord-'+numday+''+numoffice+'5-v0.mp3';

		// #################################
		// - PSAUME -
		// #################################		

		mp3_Psaume94_1 = $scope.specialDirectory+'Hicvox/Audio/eLa-P94-1-'+inv+'-v0.mp3';
		mp3_Psaume94_2 = $scope.specialDirectory+'Hicvox/Audio/eLa-P94-2-'+inv+'-v0.mp3';
		mp3_Psaume94_3 = $scope.specialDirectory+'Hicvox/Audio/eLa-P94-3-'+inv+'-v0.mp3';
		mp3_Psaume94_4 = $scope.specialDirectory+'Hicvox/Audio/eLa-P94-4-'+inv+'-v0.mp3';
		mp3_Psaume94_5 = $scope.specialDirectory+'Hicvox/Audio/eLa-P94-5-'+inv+'-v0.mp3';
		mp3_Psaume94_6 = $scope.specialDirectory+'Hicvox/Audio/eLa-P94-6-'+inv+'-v0.mp3';
		mp3_psaume_1_complies = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'1-v0.mp3';
		mp3_psaume_2_complies = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'2-v0.mp3';
		mp3_psaume_3_complies = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'3-v0.mp3';

		mp3_psaume_1_nones = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'1-v0.mp3';
		mp3_psaume_2_nones = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'2-v0.mp3';
		mp3_psaume_3_nones = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'3-v0.mp3';

		mp3_psaume_1_primes = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'1-v0.mp3';
		mp3_psaume_2_primes = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'2-v0.mp3';
		mp3_psaume_3_primes = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'3-v0.mp3';

		mp3_psaume_1_sextes = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'1-v0.mp3';
		mp3_psaume_2_sextes = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'2-v0.mp3';
		mp3_psaume_3_sextes = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'3-v0.mp3';

		mp3_psaume_1_tierces = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'1-v0.mp3';
		mp3_psaume_2_tierces = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'2-v0.mp3';
		mp3_psaume_3_tierces = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'3-v0.mp3';

		mp3_psaume_matines_1 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'1-v0.mp3';
		mp3_psaume_matines_2 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'2-v0.mp3';
		mp3_psaume_matines_3 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'3-v0.mp3';
		mp3_psaume_matines_4 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'4-v0.mp3';
		mp3_psaume_matines_5 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'5-v0.mp3';
		mp3_psaume_matines_6 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'6-v0.mp3';
		mp3_psaume_matines_7 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'7-v0.mp3';
		mp3_psaume_matines_8 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'8-v0.mp3';
		mp3_psaume_matines_9 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'9-v0.mp3';

		mp3_psaume_laudes_1 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'1-v0.mp3';
		mp3_psaume_laudes_2 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'2-v0.mp3';
		mp3_psaume_laudes_3 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'3-v0.mp3';
		mp3_psaume_laudes_4 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'4-v0.mp3';
		mp3_psaume_laudes_5 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'5-v0.mp3';

		mp3_psaume_vepres_1 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'1-v0.mp3';
		mp3_psaume_vepres_2 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'2-v0.mp3';
		mp3_psaume_vepres_3 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'3-v0.mp3';
		mp3_psaume_vepres_4 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'4-v0.mp3';
		mp3_psaume_vepres_5 = $scope.specialDirectory+'Hicvox/Audio/eLa-Psa-Ord-'+numday+''+numoffice+'5-v0.mp3';
		

		if(commun == ""){
		    mp3_capitule_laudes = $scope.specialDirectory+'Hicvox/Audio/eLa-Cap-Ord-0'+capitule_repond+''+numoffice+'-v0.mp3';
		}else{
		    mp3_capitule_laudes  = $scope.specialDirectory+'Hicvox/Audio/eLa-Hym-'+commun+'-hp'+numoffice+'-v0.mp3';
		}

		mp3_capitule_complies= $scope.specialDirectory+'Hicvox/Audio/eLa-Cap-Ord-0'+capitule_repond+''+numoffice+'-v0.mp3';				

		mp3_capitule_vepres = $scope.specialDirectory+'Hicvox/Audio/eLa-Cap-Ord-0'+capitule_repond+''+numoffice+'-v0.mp3';
		mp3_capitule_nones = $scope.specialDirectory+'Hicvox/Audio/eLa-Cap-Ord-0'+capitule_repond+''+numoffice+'-v0.mp3';
		mp3_capitule_primes = $scope.specialDirectory+'Hicvox/Audio/eLa-Cap-Ord-0'+capitule_repond+''+numoffice+'-v0.mp3';
		mp3_capitule_sextes = $scope.specialDirectory+'Hicvox/Audio/eLa-Cap-Ord-0'+capitule_repond+''+numoffice+'-v0.mp3';
		mp3_capitule_tierces = $scope.specialDirectory+'Hicvox/Audio/eLa-Cap-Ord-0'+capitule_repond+''+numoffice+'-v0.mp3';

		mp3_capitule_laudes_pascal= $scope.specialDirectory+'Hicvox/Audio/eLa-Cap-TRe-002-v0.mp3';
		mp3_capitule_tierces_pascal= $scope.specialDirectory+'Hicvox/Audio/eLa-Cap-TRe-004-v0.mp3';
		mp3_capitule_sextes_pascal= $scope.specialDirectory+'Hicvox/Audio/eLa-Cap-TRe-005-v0.mp3';
		mp3_capitule_nones_pascal= $scope.specialDirectory+'Hicvox/Audio/eLa-Cap-TRe-006-v0.mp3';
		mp3_capitule_vepres_pascal= $scope.specialDirectory+'Hicvox/Audio/eLa-Cap-TRe-007-v0.mp3';

		// #################################
		// - REPONDS -
		// #################################

		mp3_repond_1 = $scope.specialDirectory+'Hicvox/Audio/eLa-Re1-Ord-0'+capitule_repond+''+numoffice+'-v0.mp3';
		mp3_repond_2 = $scope.specialDirectory+'Hicvox/Audio/eLa-Re2-Ord-0'+capitule_repond+''+numoffice+'-v0.mp3';
		mp3_repond_complies = $scope.specialDirectory+'Hicvox/Audio/eLa-Rep-Ord-0'+capitule_repond+''+numoffice+'-v0.mp3';
		mp3_repond_nones   = $scope.specialDirectory+'Hicvox/Audio/eLa-Rep-Ord-0'+capitule_repond+''+numoffice+'-v0.mp3';
		mp3_repond_sextes = $scope.specialDirectory+'Hicvox/Audio/eLa-Rep-Ord-0'+capitule_repond+''+numoffice+'-v0.mp3';
		mp3_repond_tierces = $scope.specialDirectory+'Hicvox/Audio/eLa-Rep-Ord-0'+capitule_repond+''+numoffice+'-v0.mp3';       

		mp3_repond_tierces_pascal = $scope.specialDirectory+'Hicvox/Audio/eLa-Rep-TRe-004-v0.mp3';       
		mp3_repond_sextes_pascal = $scope.specialDirectory+'Hicvox/Audio/eLa-Rep-TRe-005-v0.mp3';       
		mp3_repond_nones_pascal = $scope.specialDirectory+'Hicvox/Audio/eLa-Rep-TRe-006-v0.mp3';  

		// #################################
		// - BENEDICTUS -     
		// #################################

		mp3_antienne_benedictus = $scope.specialDirectory+'Hicvox/Audio/eLa-AnB-Ord-'+numday+'-t7-v0.mp3';
		mp3_benedictus = $scope.specialDirectory+'Hicvox/Audio/eLa-CaB-Ord-t7-v0.mp3';

		// #################################
		// - MAGNIFICIANT -
		// #################################

		mp3_antienne_magnificat = $scope.specialDirectory+'Hicvox/Audio/eLa-AnM-Ord-'+numday+'-t7-v0.mp3';
		mp3_magnificat = $scope.specialDirectory+'Hicvox/Audio/eLa-CaM-Ord-t7-v0.mp3';

		// #################################
		// - mp3 CCO -
		// #################################

		mp3_cco = $scope.specialDirectory+'Hicvox/Audio/eLa-CCo-4'+cco+'-V0.mp3'; 

		// #################################
		// - LITURGIES DES HEURES -
		// #################################		
		mp3_lh_office     = $scope.specialDirectory+"Hicvox/Audio/oLa-InA-v0.mp3";
		mp3_lh_office_complies     = $scope.specialDirectory+"Hicvox/Audio/oFr-PsI-Com-v0.mp3";
		mp3_lh_hymne     = $scope.specialDirectory+'Hicvox/Audio/oFr-Hym-Ord-0'+hymne_lh+''+numoffice+'-v0.mp3';
		mp3_lh_antienne     = $scope.specialDirectory+'Hicvox/Audio/oFr-AnP-Ord-'+numday+''+numoffice+'1-v0.mp3';
		mp3_lh_antienne2     = $scope.specialDirectory+'Hicvox/Audio/oFr-AnP-Ord-'+numday+''+numoffice+'2-v0.mp3';
		mp3_lh_psaume     = $scope.specialDirectory+'Hicvox/Audio/oFr-Psa-Ord-'+numday+''+numoffice+'1-v0.mp3';
		mp3_lh_psaume2     = $scope.specialDirectory+'Hicvox/Audio/oFr-Psa-Ord-'+numday+''+numoffice+'2-v0.mp3';		
		mp3_lh_capitule     = $scope.specialDirectory+'Hicvox/Audio/oFr-Cap-Ord-01'+numoffice+'-v0.mp3';
		mp3_lh_repond     = $scope.specialDirectory+'Hicvox/Audio/oFr-Rep-Ord-018-v0.mp3';
		mp3_lh_can     = $scope.specialDirectory+'Hicvox/Audio/oFr-CaN-Ord-00-v0.mp3';		
		mp3_lh_ora     = $scope.specialDirectory+'Hicvox/Audio/oFr-Ora-Co01'+numoffice+'-v0.mp3';
		mp3_lh_noc     = $scope.specialDirectory+'Hicvox/Audio/oFr-Noc-v0.mp3';
		mp3_lh_cco     = $scope.specialDirectory+'Hicvox/Audio/oFr-CCo-3'+complies_cco+'-v0.mp3';
		...
		if($scope.officeSelected == true){
			...
			if($scope.office == "matines"){
				...
				path_martyrologe = $scope.specialDirectory+'Hicvox/Audio';
	...
	$scope.escKey = function() {
		$('#marqueur').css({'font-size': '15px'});
		$('#diapo_fr').css({'font-size': '15px'});
	...
	$scope.fullScreen = function() {
		if(full==0){
		  if($(window).width()< 400 && $(window).width()>= 0){
		    ...
		    $('#marqueur').css({'font-size': '20px'});
		    $('#diapo_fr').css({'font-size': '20px'});
...
function getMp3Office(annee, mois, jour, office){
	...
	if(annee == 2017 && mois == 3 && jour > 1 && (office == "matines" || office == "laudes" || office == "prime" || office == "tierces" || office == "sexte" || office == "vepres")){
	  mp3_office = $scope.specialDirectory+"Hicvox/Audio/eLa-InL-v0.mp3";
	}
